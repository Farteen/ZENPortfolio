...
#define VERSION_STRING @"CFBundleString"
...
static NSString *const kTWSReleaseNotesViewVersionKey = @"TWSReleaseNotesViewControllerVersionKey";
...
+ (BOOL)isAppVersionUpdated
{
    ...
    NSString *currentAppVersion = [[NSBundle mainBundle] infoDictionary][VERSION_STRING];
...
- (CGFloat)expectedReleaseNotesTextHeightWithWidth:(CGFloat)width;
{
    ...
    CGSize expectedLabelSize = [self.releaseNotesText boundingRectWithSize: maximumLabelSize
